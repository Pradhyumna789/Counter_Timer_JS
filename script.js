...
const timerFunction = () => {
  ...
  const intervalId = setInterval(() => {
    ...
    // Handling the case where the user enters more than 31 for the input day and more than 12 for the input month
    if((enteredDay >= 1 && enteredDay <= 31) || (enteredMonth >= 1 && enteredMonth <= 12)) {
        daysElement.innerText = "NAN";
        hoursElement.innerText = "NAN";
        minutesElement.innerText = "NAN";
        secondsElement.innerText = "NAN";
